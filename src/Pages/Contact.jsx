...
const Contact = () => {
  ...
  return (
    <section className="min-h-screen bg-[#FFF3F5] py-16 px-4 font-poppins flex items-center justify-center">
      <div className="w-full max-w-9/12 max-lg:max-w-10/12 max-md:w-11/12 mx-auto bg-white rounded-xl shadow-lg border border-gray-200 p-8 flex flex-col lg:flex-row gap-12 lg:gap-16">
